...
import { UploadProductStyled } from "./UploadProduct/UploadProductStyled";
...
const AdminEditProduct = ({ onClose, productData, fetchData }) => {
  const [data, setData] = useState({
    ...
    isThereRecipe: productData?.isThereRecipe, // Initialize the checkbox state in data
