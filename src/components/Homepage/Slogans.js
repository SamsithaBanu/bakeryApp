      ...
      {isFromRecipe ? (
        <div className="sloganContainer">
          <div className="headerWrapper">
            <i>
              <div className="header" style={{ color: "#D95F59" }}>
          ...
          <div className="mainWrapper">
            <div className="sloganItem">
              ...
              <div className="subText" style={{textAlign: 'center'}}>
                Savor the difference with every bite, where only the best
            ...
            <div className="sloganItem">
              ...
              <div className="text">Cook like a Chec</div>
              <div className="subText" style={{textAlign: 'center'}}>
                Unleash your inner chef with every dish, and turn your kitchen
            ...
            <div className="sloganItem">
              ...
              <div className="subText" style={{textAlign: 'center'}}>
                Fresh, pure, and handpicked with care, because great meals start
            ...
            <div className="sloganItem">
              ...
              <div className="subText" style={{textAlign: 'center'}}>
                Simple steps, spectacular results, bringing gourmet flavors to
                your table with ease.
              </div>
            </div>
          </div>
        </div>
