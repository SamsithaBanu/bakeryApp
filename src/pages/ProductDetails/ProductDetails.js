...
const ProductDetails = () => {
  ...
  const fetchRelatedProducts = async (productCategory, id) => {
    try {
      const CategoryWiseProduct = await fetchCategoryWiseProduct(productCategory, );
  ...
  const handleEmailShare = () => {
    const subject = 'Check out this page and find the delicious bakery products';
    ...
    <ProductDetailsStyled>
      <div className="productDetailsWrapper">
        <div className="productImage">
          <img src={data?.productImage[0]} alt="productDetailImage" />
        </div>
        <div className="productDescription">
          ...
          <div className="addToCart">
            <button className="" onClick={(e)=>handleAddToCart(e, data?._id)}>Add to cart</button>
          ...
          <div className="shareWrapper">
            ...
            <tr className="share">
              <td className="shares">
                <FaFacebook size={25} color={"#9f2b68"} onClick={handleFacebookShare} />
              </td>
              <td className="shares">
                <FaTwitter size={25} color={"#9f2b68"} onClick={handleShare}/>
              </td>
              <td className="shares">
                <FaWhatsapp size={25} color={"#9f2b68"} onClick={handleWhatsAppShare}/>
              </td>
              <td className="shares">
                <MdOutlineMailOutline size={25} color={"#9f2b68"} onClick={handleEmailShare}/>
              </td>
            </tr>
          </div>
        </div>
