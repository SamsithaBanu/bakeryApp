  ...
  return (
    <RecipeDetailsStyled>
      <div className="leftSideWrapper">
        ...
        <AllReviews recipeId={params?.id} reviewAdded={reviewAdded} onGetReview={(val)=>setAverageReview(val)} />
        <Reviews recipeId={params?.id} onChangeRecipe={()=>setReviewAdded(true)} />
      </div>
      <div
