...
const MyCart = () => {
  ...
  const totalWholePrice = data.reduce((preve, curr)=> preve + (curr.quantity * curr?.productId?.price), 0);
    ...
    <MyCartStyled>
      <div className="leftWrapper">
        ...
        <div className="totalItemsWrapper">
          <div className="total">Total:<b>  {totalQty}</b> Item(s)</div>
          <div className="addtoCartWrapper">
            <div className="topwrapper">
              ...
              <div className="right"><b>{totalQty}</b> item(s)</div>
            </div>
      ...
      <div className="rightWrapper">
        <Summary totalPrice={totalPrice} totalWholePrice={totalWholePrice} difference={difference} servicePrice={servicePrice} />
      </div>
    </MyCartStyled>
  );
};
